import { ABOUT_LOCATION, RESUME_LOCATION, TRASH_LOCATION, WORK_LOCATION } from "@constants/index";
...
export const locations = {
    ...
    trash: TRASH_LOCATION as AppItem,
}
...
const useLocationStore = create<State & Actions>()(immer((set) => ({
    activeLocation: 'work', 
    ...
    setSelectedWorkId: (id: number | null) =>
        set((state) => { state.selectedWorkId = id }),
})))
